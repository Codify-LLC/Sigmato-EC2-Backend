...
class AddCarloanWidget extends StatefulWidget {
  const AddCarloanWidget({Key? key}) : super(key: key);

  @override
  _AddCarloanWidgetState createState() => _AddCarloanWidgetState();
}

class _AddCarloanWidgetState extends State<AddCarloanWidget> {
  ...
  Future addOutstandingCarLoanDetails() async {
    ...
    try {
      var data = {
        "carLoan": {
          "carLoanProvider": textController1?.text,
      ...
      FFAppState().carLoanList.add(listData);
                  ...
                  child: InkWell(
                    onTap: () async {
                      if (textController1?.text != "" &&
                        ...
                        await addOutstandingCarLoanDetails();
                      } else {
                        Fluttertoast.showToast(
