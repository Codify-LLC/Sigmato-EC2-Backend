...
class EditPreviousAddress extends StatefulWidget {
  EditPreviousAddress({Key? key}) : super(key: key);

  @override
  State<EditPreviousAddress> createState() => _EditPreviousAddressState();
}

class _EditPreviousAddressState extends State<EditPreviousAddress> {
  ...
  Future fillDetails() async {
    ...
    print(data);
    final currentAdd = jsonDecode(data["previousaddress"]);
