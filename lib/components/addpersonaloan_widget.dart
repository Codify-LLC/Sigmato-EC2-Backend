...
class AddpersonaloanWidget extends StatefulWidget {
  const AddpersonaloanWidget({Key? key}) : super(key: key);

  @override
  _AddpersonaloanWidgetState createState() => _AddpersonaloanWidgetState();
}

class _AddpersonaloanWidgetState extends State<AddpersonaloanWidget> {
  ...
  Future addOutstandingPersonalLoanDetails() async {
    ...
    try {
      var data = {
        "personalLoan": {
          "personalLoanProvider": textController1?.text,
      ...
      FFAppState().personalLoanList.add(listData);
      // print(FFAppState().creditCardList);
      // print(FFAppState().creditCardList[0]);
                  ...
                  child: InkWell(
                    onTap: () async {
                      if (textController1?.text != "" &&
                        ...
                        await addOutstandingPersonalLoanDetails();
                      } else {
                        Fluttertoast.showToast(
