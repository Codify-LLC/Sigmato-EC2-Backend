import 'package:freedom/documentupload/documentupload_widget.dart';
...
class CurrentResidenceDetailsWidget extends StatefulWidget {
  const CurrentResidenceDetailsWidget({Key? key}) : super(key: key);

  @override
  _CurrentResidenceDetailsWidgetState createState() =>
      _CurrentResidenceDetailsWidgetState();
}

class _CurrentResidenceDetailsWidgetState
    extends State<CurrentResidenceDetailsWidget> {
